...
import type { AddressType, ProductsType } from "../utils/types";
import toast from "react-hot-toast";

const Cart = () => {
  const { products, user, currency, cartItems, setCartItems, removeFromCart, getCartCount, getCartAmount, updateCartItem, navigate, axios } = useAppContext();
  const [cartArray, setCartArray] = useState<ProductsType[]>([]);
        ...
        {cartArray.map((product, index) => (
          ...
          >
            ...
            <p className="text-center">
              {currency}{product.offerPrice * (product.quantity || 1)}
            </p>
